...
truckRoute.post("/",upload,validate(truckValidation.createTruck), TruckController.createTruck);
truckRoute.patch("/:truckId", upload,validate(truckValidation.createTruck), TruckController.updateTruck);
